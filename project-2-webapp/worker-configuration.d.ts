/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4ee50bb0e155d1b4ab7640ac89da86d7)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		WEBHOOK_URL: "";
		R2_CUSTOM_DOMAIN: "";
		WORKFLOW_PROCESS_ORDER: Workflow<Parameters<import("./src/worker/index").ProcessOrder['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WEBHOOK_URL" | "R2_CUSTOM_DOMAIN">> {}
}
